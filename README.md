...
```
bash <(curl -s https://raw.githubusercontent.com/Aryan-Ebadi/masterbot/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/Aryan-Ebadi/masterbot/main/update.sh)
```
