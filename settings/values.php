...
",
    ...
    'start_message' => '🥇برترین ارائه دهنده وی پی ان در سراسر کشور🥇
💎 با 5 سال سابقه فعالیت 💎
    
👈👈 تضمین عدم قطعی وجه تمایز ماست 👉👉

📡 متصل با تمامی اپراتور ها و دستگاه ها
...
[پیام به پشتیبانی](https://t.me/vpn_masters_admin)
...
سمت راست درآمد و سمت چپ تعداد خرید نماینده می باشد',
    'send_config_remark' => "لطفا کد آخر کانفیگ یا اسم کانفیگ را وارد کنید",
