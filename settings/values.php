...
$mainValues = [
    ...
    'customer_custome_plan_name' => '
    اسم کانفیگ رو وارد کن ( حروف انگیلیسی کوچک و عدد باهم وارد کنید )
    مثلا: saman101
    ❗ از حروف بزرگ استفاده نکنید
    ❗ اگر بعد خرید با خطا مواجه شدید به خاطر تکراری بودن نام وارد شده در سرور میباشد، به پشتیبانی اطلاع دهید
    ',
    ...
    'increase_wallet_cart_to_cart' => "♻️ یک تصویر از فیش واریزی ارسال کنید :
...
✅ بعد از اینکه پرداختت تایید شد ( لینک سرور ) به صورت خودکار از طریق همین ربات برات ارسال میشه!",
    'renew_ccount_cart_to_cart' => "♻️  یک تصویر از فیش واریزی یا شماره پیگیری -  ساعت پرداخت - نام پرداخت کننده رو در یک پیام برام ارسال کن :
...
",
    ...
    'you_dont_have_config' => 'دوست عزیز هیچ سفارشی نداری 🙁 باید یه کانفیگ خریداری کنی',
...
",
    ...
    'start_message' => 'فروشگاه اکانت های اسپاتیفای و اپل آیدی
    ',
    'new_member_joined' => "📢 | یه کاربر جدید عضو ربات شد :
...
💰مقدار تخفیف: AMOUNT تومان
⁮⁮ ⁮⁮",
    "send_config_uuid" => "❗️| لینک اتصال یا uuid رو برام بفرس اطلاعات کامل رو تحویلت بدم ",
...
سمت راست درآمد و سمت چپ تعداد خرید نماینده می باشد',
    'send_config_remark' => "لطفا کد آخر لینک یا اسم لینک را وارد کنید",
    ...
    "sent_config_to_user" => '✅ لینک و براش ارسال کردم
ریمارک: REMARK
حجم سرویس: VOLUME گیگ
...
$buttonValues = [
    ...
    'search_agent_config' => "جستجوی اکانت",
    'search_admin_config' => "جستجوی اکانت کاربر",
